...
|
| era, kubernetes, ncp, network_operator, slow
| Local evidence Provider wiring and unit coverage for ENT-REQ-013; Labs attachment upload remains required
| P0
a|
| LimitedEnv
|
...
| Composite E2E use case: live-qualified on a two-node Ubuntu 24.04 single-rail cluster; the multi-rail member is skipped as inapplicable
| P0
a|
| LimitedEnv
|
...
| Composite E2E use case: preflight, discover, generate, deploy, and validate
| P0
a|
| LimitedEnv
|
...
| Composite E2E use case: preflight, discover, generate, deploy, and validate; live VM qualification remains required
| P0
a|
| LimitedEnv
|
